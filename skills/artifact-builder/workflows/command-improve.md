...
7. CHECK tool alignment:
   ...
   - EXTRACT allowed-tools from command frontmatter
   - ANALYZE command operations (reading files, writing, running bash, etc.)
   - VERIFY tools match operations described in command
